...
const { penyediaController, tambahModemController, uploadBAKController } = require('../controllers/serviceController/penyediaController');
...
const { upload2, upload, uploadBAK } = require('../middleware/testimonialsFileManager');
...
serviceRouter.get('/penyedia/update/status/:status/:id/:plan', statusUpdateController);
serviceRouter.get('/penyedia/delete/status/:id', statusDeleteController);
...
serviceRouter.get('/superuser/monitoring/update/status/:status/:id/:plan', statusUpdateController);
